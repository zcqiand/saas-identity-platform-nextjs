...
// M01.F04.I05 — /api/v1/auth/refresh
//
...
describe("M01.F04.I05 /api/v1/auth/refresh", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("M01.F04.I05 returns 400 INVALID_GRANT when refreshToken unknown", async () => {
  ...
  it("M01.F04.I05 returns 400 when grantType not refresh_token", async () => {
    const res = await POST(
