// /api/v1/tenants/[t]/members/:userId/roles — M01.F02.I01
//
// TypeSpec: tsp/routes/tenant-members.tsp assignRoles(@path tenantId, @path userId, @body body: { roleIds: string[] }): User
...
// tenantMemberRole(userId, roleId) — 通过 tenantMember.id 关联。
